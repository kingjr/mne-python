...
def _make_scorer(scoring):
    ...
    scorer : callable | None
        The scorer.
    """
    from sklearn.metrics import make_scorer, get_scorer, roc_auc_score
    ...
    if scoring is None:
        ...
        # XXX sklearn < 0.18 has a bug: it thinks auc needs a thresholded
        # prediction. This is a quick backport fix.
        if scoring == 'roc_auc':
